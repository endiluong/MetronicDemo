...
export class CustomersListComponent implements OnInit {
  ...
  /** Fetch */
  fetchCustomers() {
    const messages: any[] | { text: string; id: string; status: number; }[] = [];
  ...
  updateStatusForCustomers() {
    ...
    // tslint:disable-next-line:max-line-length
    const _messages: any[] | { text: string; id: string; status: number; statusTitle: string; statusCssClass: string; }[] = [];
